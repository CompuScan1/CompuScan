...
import { crearEquipo } from '../services/equiposService';
...
export default function RegistroEquipo() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!currentUser) {
      return setError('Debes iniciar sesión para registrar un equipo');
    }
    ...
    try {
      ...
      // Guardar información del equipo en Firestore
      await crearEquipo({
        ...formData,
