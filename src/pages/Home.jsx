...
export default function Home() {
  ...
  const renderPersonalizedContent = () => {
    ...
    if (userRole === 'instructor') {
      return (
        <div className="bg-gradient-to-r from-[#FF6600] to-[#E65C00] text-white p-8 rounded-xl shadow-lg mb-12 transform hover:scale-[1.02] transition-transform">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a 
              href="/equipos" 
              className="bg-white text-[#FF6600] hover:bg-orange-50 font-bold py-3 px-6 rounded-lg transition duration-300 text-center shadow-md hover:shadow-xl"
            >
              Mis Equipos
            </a>
            <a 
    ...
    // Para cualquier otro rol o usuarios sin rol asignado, mostrar vista de Aprendiz
    return (
      <div className="bg-gradient-to-r from-[#39A900] to-[#2D8C00] text-white p-8 rounded-xl shadow-lg mb-12 transform hover:scale-[1.02] transition-transform">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            {!currentUser && (
              <div className="flex justify-center gap-4">
                ...
                <a 
                  href="/login" 
                  className="inline-block bg-[#FF6600] text-white font-bold py-4 px-8 rounded-xl hover:bg-[#E65C00] transition-all duration-300 shadow-lg transform hover:scale-105"
                >
                  Iniciar Sesión
                </a>
              </div>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
              <div className="text-[#FF6600] mb-6 flex justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold mb-4 text-center text-[#FF6600]">Eficiencia Total</h3>
              <p className="text-gray-600 text-center leading-relaxed">
        ...
        {/* Process Section */}
        <section className="bg-gradient-to-r from-green-50 to-green-100 p-12 rounded-2xl shadow-lg mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-[#39A900]">
            Proceso Simple
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center transform hover:scale-105 transition-all duration-300">
              <div className="bg-white h-20 w-20 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                <span className="text-3xl font-bold text-[#FF6600]">2</span>
              </div>
              <h3 className="text-xl font-bold mb-4 text-[#FF6600]">Configura</h3>
              <p className="text-gray-600 leading-relaxed">
        ...
        <section className="text-center max-w-4xl mx-auto bg-white p-12 rounded-2xl shadow-lg">
          ...
          <a 
            ...
            className="inline-block bg-gradient-to-r from-[#39A900] to-[#2D8C00] text-white font-bold py-4 px-8 rounded-xl hover:opacity-90 transition-all duration-300 shadow-lg transform hover:scale-105"
          >
            {currentUser ? "Ir a mi Panel" : "Comenzar Ahora"}
          </a>
        </section>
      </div>
    </div>
