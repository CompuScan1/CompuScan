    ...
    <div className="bg-gray-50 min-h-screen py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-8 sm:p-10 bg-gradient-to-r from-blue-500 to-indigo-600 text-white">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="relative group mb-6 md:mb-0">
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                  <button
                    ...
                    className="bg-blue-900 bg-opacity-75 hover:bg-opacity-90 text-white rounded-full p-2 shadow-lg"
              ...
              {selectedFile && (
                <div className="md:ml-6 text-center md:text-left">
                  <p className="text-sm text-white bg-blue-900 bg-opacity-30 px-4 py-2 rounded-lg mb-3">
                    Nueva imagen seleccionada
                  </p>
                  <button
                    onClick={handleUploadPhoto}
                    className="bg-white text-blue-700 hover:bg-blue-50 font-medium py-2 px-4 rounded-lg shadow-md transition-colors duration-200"
                    disabled={uploadingPhoto}
                  >
                    {uploadingPhoto ? (
              ...
              <div className="md:ml-8 text-center md:text-left">
                ...
                <div className="mt-3">
                  <span className="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-blue-900 bg-opacity-25">
                    {userRole || 'Aprendiz'}
                  </span>
                </div>
              </div>
